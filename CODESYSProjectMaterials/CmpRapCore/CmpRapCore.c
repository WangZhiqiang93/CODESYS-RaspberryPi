...
//void CDECL CDECL_EXT writebyte(writebyte_struct *p)
//{
//	DEV_Digital_Write(MAX7219_CS_PIN, 0);
 //   DEV_SPI_WriteByte(p->byReg);
//}
//void CDECL CDECL_EXT initmoduledriver(initmoduledriver_struct *p)
//{
//	//p->WriteByte = DEV_ModuleInit();
//	DEV_ModuleInit();
//}
void CDECL CDECL_EXT moduleinit(moduleinit_struct *p)
{
	p->ModuleInit=DEV_ModuleInit();
}
...
{
	DEV_Digital_Write(MAX7219_CS_PIN, 1);
}
