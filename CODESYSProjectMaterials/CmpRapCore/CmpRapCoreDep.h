 ...
 *  </copyright>
 */
#ifndef _CMPRAPCOREDEP_H_
#define _CMPRAPCOREDEP_H_

#define COMPONENT_NAME "CmpRapCore" COMPONENT_NAME_POSTFIX
#define COMPONENT_ID    ADDVENDORID(CMP_VENDORID, CMPID_CmpRapCore)
#define COMPONENT_NAME_UNQUOTED CmpRapCore
...
#define CMPID_CmpRapCore		0x2000								/* NOTE: START HERE WITH YOUR COMPONENTIDS (see CmpItf.h */
#define CLASSID_CCmpRapCore	ADDVENDORID(CMP_VENDORID, 0x2000)	/* NOTE: START HERE WITH YOUR CLASSIDS (see CmpItf.h */
#define ITFID_ICmpRapCore		ADDVENDORID(CMP_VENDORID, 0x2000)	/* NOTE: START HERE WITH YOUR INTERFACEIDS (see CmpItf.h */
...
#ifndef CMPRAPCORE_DISABLE_EXTREF
#define EXPORT_EXTREF_STMT \
        { (RTS_VOID_FCTPTR)writecspin_1, "writecspin_1", 0xD0F3C969, 0x03050F1E },\
          { (RTS_VOID_FCTPTR)writecspin_0, "writecspin_0", 0x70C8F91E, 0x03050F1E },\
          { (RTS_VOID_FCTPTR)spi_writebyte, "spi_writebyte", 0x0A92F672, 0x03050F1E },\
          { (RTS_VOID_FCTPTR)moduleinit, "moduleinit", 0x271B3579, 0x03050F1E },\
          
#else
#define EXPORT_EXTREF_STMT
#endif
#ifndef CMPRAPCORE_DISABLE_EXTREF2
#define EXPORT_EXTREF2_STMT \
                
#else
#define EXPORT_EXTREF2_STMT
#endif
#if !defined(CMPRAPCORE_DISABLE_CMPITF) && !defined(STATIC_LINK) && !defined(CPLUSPLUS) && !defined(CPLUSPLUS_ONLY)
...
#define USEEXTERN_STMT \
    ...
    #define ComponentEntry CmpRapCore__Entry
#endif


#ifdef CPLUSPLUS

class CCmpRapCore : public ICmpRapCore 
{
    public:
        CCmpRapCore() : hCmpRapCore(RTS_INVALID_HANDLE), iRefCount(0)
        {
        }
        virtual ~CCmpRapCore()
        {
        ...
        virtual void* QueryInterface(IBase *pIBase, ITFID iid, RTS_RESULT *pResult)
        {
            void *pItf;
            if (iid == ITFID_IBase)
                pItf = dynamic_cast<IBase *>((ICmpRapCore *)this);            
            else if (iid == ITFID_ICmpRapCore)
                pItf = dynamic_cast<ICmpRapCore *>(this); 
            else
            {
                if (pResult != NULL)
    ...
    public:
        RTS_HANDLE hCmpRapCore;
        int iRefCount;
};

#endif /*CPLUSPLUS*/
#ifdef RTS_COMPACT_MICRO
/* CmpRapCore Declarations for uRTS */
...
#define USE_HOOK_FUNCTION	RTS_RESULT CmpRapCore_HookFunction(RTS_UI32 ulHook, RTS_UINTPTR ulParam1, RTS_UINTPTR ulParam2)\
{\
...
#define USE_EXPORT_EXTREF const CMP_EXT_FUNCTION_REF CmpRapCore_ExternalsTable[] = \
	{\
		EXPORT_EXTREF_STMT\
		EXPORT_EXTREF2_STMT\
